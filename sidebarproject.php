...
<i class="mdi mdi-login "></i>
        ...
        <div class="dropdown-menu dropdown-menu-right sidebar-dropdown preview-list" aria-labelledby="profile-dropdown"  style = "overflow:hidden">
          <?php if(!isset($_SESSION['LoggedIn'])){?>
  ...
  <?php }?>
    ...
    <li class="nav-item menu-items">
      ...
      <div class="collapse show" id="notes">
        <ul class="nav flex-column sub-menu"  style = "overflow:hidden">
          ...
          <li class="nav-item"> <a onclick="addShow(<?php  echo "'".$posts[$i]['tag']."'";?> )" class="nav-link" href="#<?php echo $posts[$i]['tag'];?>"><?php echo $posts[$i]['title'];?></a></li>
        <?php }?>
        </ul>
      </div>
    </li>
    ...
    <li class="nav-item menu-items">
      ...
      <div class="collapse" id="projects" style = "overflow:hidden">
        <ul class="nav flex-column sub-menu" style = "overflow:hidden">
          ...
          <li class="nav-item"> <a class="nav-link" href="/project/view/recursive"> Recursive Shapes</a></li>
        </ul>
      </div>
    </li>
