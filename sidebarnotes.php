...
<i class="mdi mdi-login "></i>
  ...
  <?php }?>
    ...
    <li class="nav-item menu-items ">
      <a class="nav-link active" href="/<?php if(false&&isset($_SESSION['LoggedIn'])) echo 'dash'; ?>">
    ...
    <li class="nav-item menu-items active" style = "text-overflow: hidden" >
      <a class="nav-link active" data-toggle="collapse" href="#unit" aria-expanded="true" aria-controls="unit">
        <span class="menu-icon">
          <i class="mdi mdi-notebook"></i>
        </span>
        <span class="menu-title">Unit <?php echo $unit;?></span>
        <i class="menu-arrow"></i>
      </a>
      <div class="collapse show" id="unit" >
        <ul class="nav flex-column sub-menu" style = "overflow: hidden" >
          <?php for($i = 0; $i < count($response); $i++) {
              if(strlen($response[$i]['title'])<3){ continue; }
            ?>
          <li  class="nav-item"> <a class="nav-link" href="#<?php echo $response[$i]['title'];?>"><?php echo $response[$i]['title'];?></a></li>
        <?php }?>
        </ul>
      </div>
    </li>
    ...
    <li class="nav-item menu-items">
      ...
      <div class="collapse" id="projects">
        <ul class="nav flex-column sub-menu">
          ...
          <li class="nav-item"> <a class="nav-link" href="/project/pong"> Pong </a></li>
    ...
    <li class="nav-item menu-items">
      ...
      <div class="collapse" id="github">
        <ul class="nav flex-column sub-menu" style = "overflow-x: hidden">
          ...
          <li class="nav-item"> <a class="nav-link" href="/github/#introduction/">Getting Started </a></li>
          <li class="nav-item"> <a class="nav-link" href="/github/#accept">GitHub Classroom Assignment </a></li>
          <li class="nav-item"> <a class="nav-link" href="/github/#token">Personal Access Token</a></li>
          <li class="nav-item"> <a class="nav-link" href="/github/#clone">Cloning a Repo in Eclipse </a></li>
          <li class="nav-item"> <a class="nav-link" href="/github/#commit">Commiting and Pushing Updates </a></li>
          <li class="nav-item"> <a class="nav-link" href="/github/#adding">Adding Existing Projects to a Repo</a></li>
          <li class="nav-item"> <a class="nav-link" href="/github/#pull">Updating Existing Projects in Eclipse from GitHub</a></li>
          <li class="nav-item"> <a class="nav-link" href="/github/#help">Troubleshooting</a></li>
