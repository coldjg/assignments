  ...
  <?php }?>
    ...
    <li class="nav-item menu-items">
      <a class="nav-link" data-toggle="collapse" href="#notes" aria-expanded="false" aria-controls="notes">
        ...
        <span class="menu-title">Pong</span>
      ...
      <div class="collapse" id="notes">
        <ul class="nav flex-column sub-menu">
          ...
          <li class="nav-item"> <a class="nav-link" href="/project/pong#vars">Instance Variables</a></li>
          <li class="nav-item"> <a class="nav-link" href="/project/pong#paint">Paint Method (Drawing)</a></li>
          <li class="nav-item"> <a class="nav-link" href="/project/pong#update">Update Method</a></li>
          <li class="nav-item"> <a class="nav-link" href="/project/pong#key">KeyListener</a></li>
          <li class="nav-item"> <a class="nav-link" href="/project/pong#key">Collision Detection</a></li>
          <li class="nav-item"> <a class="nav-link" href="/project/pong#key">Scoring</a></li>
          <li class="nav-item"> <a class="nav-link" href="/project/pong#key">Reset</a></li>
          <li class="nav-item"> <a class="nav-link" href="/project/pong#key">Minor Details</a></li>
